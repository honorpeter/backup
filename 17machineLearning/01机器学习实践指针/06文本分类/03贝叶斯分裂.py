...
#code:myhaspl@qq.com
'''
贝叶斯是一种基于概率的学习算法 其性能可与决策树 神经网络算法 媲美是文本
    挖掘技术的典型代表

    算法描述:
        1 活取样本文本,进行人工分类整理 并进行标记
        2 对每个类别的样本文本进行中文分析
        3 去除样本中垃圾词条
        4 将整理后的词条合成样本文本的特征组 分析并计算词条概率信息
        5 根据词条概率信息 计算词条在各类别中文本的先验概率 词条I的各类...
        6 读取位置文本,进行中文分析 并去除垃圾词 然后形成样本特征组
        7 那个未知样本特征词条的先验概率代入贝叶斯公式计算 后验概率 计算
            得到最大的就是
'''
